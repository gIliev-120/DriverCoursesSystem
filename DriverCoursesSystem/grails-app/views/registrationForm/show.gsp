	...
	<body>
		...
		<div id="show-registrationForm" class="content scaffold-show" role="main">
			...
			<ol class="property-list registrationForm">
				...
				<g:if test="${registrationFormInstance?.username}">
				<li class="fieldcontain">
					<span id="username-label" class="property-label"><g:message code="registrationForm.username.label" default="Username" /></span>
					
						<span class="property-value" aria-labelledby="username-label"><g:fieldValue bean="${registrationFormInstance}" field="username"/></span>
