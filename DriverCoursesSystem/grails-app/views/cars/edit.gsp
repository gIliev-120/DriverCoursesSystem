...
<html>
	...
	<body>
		<a href="#edit-cars" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-cars" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:carsInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${carsInstance?.version}" />
				<fieldset class="form">
