...
<li class="add">
<g:link controller="students" action="create" params="['course.id': courseInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'students.label', default: 'Students')])}</g:link>
</li>
</ul>
